...
<div class="post"><p><?php if($value[thumb]):?><img src="<?php echo $value[thumb];?>"><?endif;?></p><p><?php echo $value[content];?></p></div>	
<p class="post-footer align-left">
<?php if($value[tags]):?>标签：<?php echo $value['tags'];?><br><?endif;?>  
