...
<?php if($pagination):?><p id='pagenav'><?php echo $pagination;?></p><?endif;?>
...
<?php endif;?>
<input class="button submit" type="submit" id="submit" value="立 刻 开 炮"/>	
<input class="button" type="reset" value="重 装 炮 弹" />	
</p>	
