...
?>
<div class="box2">
<h3 class="sort_<?php echo $value[sort_id];?>">
<img src="<?php echo $sort_logo;?>" alt="博客分类: <?php echo $value[name];?>"title="查看分类:<?php echo $value[name];?>"border="0"/>
<a href="<?php echo $theurl;?>"><!--<?php echo $value[name];?>--><?php echo $$CMS_NAME;?></a>
</h3>
<div class="box">
<ul class="otherul">
...
<li><a href="<?php echo $achive_url;?>" title="<?php echo $value[title];?>" style="color:#fe4e00;"><?php echo $value[title];?></a></li>
