...
<div id="main">
<div class="place">
<?php echo $front_header[1];?>:<a href="./"><? echo $dyhb_options[blog_title];?></a> &raquo; <a href="./" title="<?php echo $front_header[0];?>"><?php echo $front_header[0];?></a> 
<?php _global_blog_pagenav();?>
</div>
<h2>
<?php 
//判断是否是页面，页面则不用加载相关日志等等
if($ShowLog['ispage']=='0'):?><?php toplog($ShowLog['istop']);?><?php mobilelog($ShowLog['ismobile']);?><?endif;?><?php echo $ShowLog['title'];?>
</h2>
...
<?php if($ShowLog[tags]):?>标签：<?php echo $ShowLog['tags'];?><br><?php endif;?>  
